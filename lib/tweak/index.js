		...
		db.get('tweak_version', function (e, doc) {
			...
			async.forEach(watch.resources, function (resource, next) {
				...
				updateTweak(db, doc, watch.database, function (e) {
					if (e) return app.log.error('[Tweak] can\'t save tweak document : ' + watch.database + ' :', e);
...
*/
updateAll = function (db, update, database, next) {
...
@param {Function} next(e)
*/
updateTweak = function (db, doc, database, next) {
